...
CREATE TABLE project_list(ID integer PRIMARY KEY, project_name text);
CREATE TABLE presentation(ID integer PRIMARY KEY, project_ID integer, FOREIGN KEY (project_ID) REFERENCES project_list(ID), version integer, primary_status boolean);
